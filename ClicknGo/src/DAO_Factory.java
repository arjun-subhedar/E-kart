...
public class DAO_Factory{
	...
	static final String DB_URL = "jdbc:mysql://localhost:3306/ClickNGo?characterEncoding=latin1&useConfigs=maxPerformance";
	static final String USER = "root";
	static final String PASS = "Kushal123";
	Connection dbconnection = null;

	// You can add additional DAOs here as needed
	ClicknGO studentDAO = null;
	...
	public ClicknGO getStudentDAO() throws Exception
	{
		if( activeConnection == false )
			throw new Exception("Connection not activated...");

		if( studentDAO == null )
			studentDAO = new ClickNGo_JDBC( dbconnection );
